<template>
	<div>
		...
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>租赁资料管理</el-breadcrumb-item>
		</el-breadcrumb>
		<div class="t_box">
			<div class="search">
				<el-form ref="formInline" :model="formInline" :inline="true">
					<el-form-item label="租赁人姓名">
						<el-input size="mini" v-model="formInline.name" placeholder="请输入租赁人姓名"></el-input>
					</el-form-item>
...
<script>
	...
	export default {
		...
		methods: {
			...
			edit() {
				request({
					url: "http://127.0.0.1:10520/api/admin/updateLeasehold",
					method: "post",
					data: this.infoList
				}).then(res => {
					console.log(res);
			...
			deleteHouse(id) {
				this.$confirm('删除后将无法恢复!, 是否继续?', '提示', {
					...
					.then(() => {
						request({
							url: "http://127.0.0.1:10520/api/admin/deleteLeasehold",
							method: "post",
							data: {
								id: id
							}
