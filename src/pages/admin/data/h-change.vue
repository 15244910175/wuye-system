<template>
	<div>
		...
		<div class="t_box">
			<div class="search">
				<el-form ref="formInline" :model="formInline" :inline="true">
					<el-form-item label="房号">
						<el-input size="mini" v-model="formInline.rNo" placeholder="请输入房号"></el-input>
					</el-form-item>
			...
			<div class="page">
				<el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
					:current-page="currentPage" :page-sizes="[8,14,24,32]" :page-size="pagesize"
					layout="total, prev, pager, next, sizes, jumper" :total="typeList.length">
				</el-pagination>
			</div>
		</div>

		<el-dialog title="新增产权变更信息" :visible.sync="dialogTableVisible">
			<el-form ref="addForm" :model="addForm" :rules="addFormRules" label-width="120px">
				...
				<el-form-item label="产权变更时间" prop="changedate">
					<el-date-picker v-model="addForm.changedate" type="date" placeholder="请选择产权变更时间"
		...
		<el-dialog title="编辑产权变更管理" :visible.sync="dialogTableVisible1">
			<el-form ref="infoList" :model="infoList" :rules="infoListRules" label-width="120px">
				...
				<el-form-item label="变更时间" prop="changedate">
					<el-date-picker v-model="infoList.changedate" type="date" placeholder="请选择产权变更时间"
						style="width: 100%;"></el-date-picker>
				</el-form-item>
	...
	export default {
		...
		methods: {
			...
			searchTab() {
				var self=this;
				axios
				    .get("http://127.0.0.1:10520/api/admin/queryHchange",{
					params:{
